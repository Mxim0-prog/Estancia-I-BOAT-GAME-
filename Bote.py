...
class Bote:
    #esta clase gestiona el comportamiento principal del juego
    def __init__(self):
        #inicia el juego
        pygame.init()
        self.ajustes = Ajustes()

        #llama a los ajustes de la pantalla del juego
        ...
        #instancia al jugador y las entidades del juego
    ...
    #añade enemigos segun una probabilidad al azar
    ...
    #añade los recolectables segun una probabilidad al azar
    def enviarPlasticos(self):
        if len(self.plasticos)<0:
            ...
            self.plasticos.add(bottle)
            self.plasticos.add(bag)
            #reduce el contador de los plasticos que se pueden dejar escapar   
            self.plasticoHuir -= 1         

    #Elimina a los enemigos al salir de la pantalla por la parte inferior
    ...
    #Elimina a los recolectables al salir de la pantalla por la parte inferior
    ...
    #Gestiona las colisiones del jugador con los enemigos y recolectables
    def colisionJugador(self):
        ...
        #suma puntos al recolectar plasticos 
        if len(colisionBotella) != 0:
            self.puntuacionJugador += 10
            self.plasticoHuir += 1
        #resta vidas al colisionar con un enemigo
        if len(colisionPez) != 0:
            self.salud -= 1
            self.muerto()

    #verifica la condicion para el gameover
    def muerto(self):
        if self.salud<=0 or self.plasticoHuir<=0:
            self.gameover = True
            
    #actualiza la posicion de todos los enemigos
    def actualizarEnemigos(self):
        self.enemigos.update()

    #actializa la posicion de todos los plasticos
    def actualizarPlasticos(self):
        self.plasticos.update()

    #dibuja los elementos en la pantalla y los actualiza
    ...
    #responde a los eventos de pulsaciones 
    ...
    #muestra el contador de plasticos permitidos escapar antes de perder
